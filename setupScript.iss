...
[Icons]
Name: "{group}\TPUQuest"; Filename: "{app}\TPUQuest.exe"
Name: "{group}\{cm:UninstallProgram,TPUQuest}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\TPUQuest"; Filename: "{app}\TPUQuest.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\TPUQuest.exe"; Description: "{cm:LaunchProgram,TPUQuest}"; Flags: nowait postinstall skipifsilent
